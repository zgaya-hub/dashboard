...
export default function ConfirmationModal({ isOpen, onClose, onConfirm, cancelButtonText, confirmButtonText, children, title, disabledCancelButton, disabledConfirmButton, variant = "primary" }: ConfirmationModalProps) {
  ...
  const dialogActions = (
    <>
      <Button onClick={onClose} variant="text" color={variant} disabled={disabledCancelButton}>
        {cancelButtonText ?? t("Component.Modals.ConfirmationModal.cancel")}
      </Button>
      <Button onClick={handleOnConfirm} variant="contained" color={variant} disabled={disabledConfirmButton}>
  ...
  return (
    <Dialog dividers={false} open={isOpen} onClose={onClose} headerText={title ?? t("Component.Modals.ConfirmationModal.title")} hideCrossButton dialogAction={dialogActions}>
