  ...
  return (
    <Stack component={Paper} elevation={3} p={3} sx={{ width: 400, margin: "auto" }}>
      ...
      <Stack component="form" noValidate onSubmit={handleSubmit} spacing={2}>
        <SimpleTextInput margin="normal" required fullWidth id="email" label="Email Address" name="email" autoComplete="email" autoFocus />
        <SimpleTextInput margin="normal" required fullWidth name="password" label="Password" type="password" id="password" autoComplete="current-password" />
